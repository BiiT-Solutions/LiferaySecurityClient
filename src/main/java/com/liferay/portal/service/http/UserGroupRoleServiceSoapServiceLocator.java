...
public class UserGroupRoleServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.portal.service.http.UserGroupRoleServiceSoapService {
    ...
    public com.liferay.portal.service.http.UserGroupRoleServiceSoap getPortal_UserGroupRoleService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.portal.service.http.UserGroupRoleServiceSoap getPortal_UserGroupRoleService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub _stub = new com.liferay.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.portal.service.http.UserGroupRoleServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub _stub = new com.liferay.portal.service.http.Portal_UserGroupRoleServiceSoapBindingStub(new java.net.URL(Portal_UserGroupRoleService_address), this);
                _stub.setPortName(getPortal_UserGroupRoleServiceWSDDServiceName());
                return _stub;
            }
        }
