...
public class UserGroupServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.liferay.portal.service.http.UserGroupServiceSoapService {
    ...
    public com.liferay.portal.service.http.UserGroupServiceSoap getPortal_UserGroupService() throws javax.xml.rpc.ServiceException {
    ...
    public com.liferay.portal.service.http.UserGroupServiceSoap getPortal_UserGroupService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.liferay.portal.service.http.Portal_UserGroupServiceSoapBindingStub _stub = new com.liferay.portal.service.http.Portal_UserGroupServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.liferay.portal.service.http.UserGroupServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.liferay.portal.service.http.Portal_UserGroupServiceSoapBindingStub _stub = new com.liferay.portal.service.http.Portal_UserGroupServiceSoapBindingStub(new java.net.URL(Portal_UserGroupService_address), this);
                _stub.setPortName(getPortal_UserGroupServiceWSDDServiceName());
                return _stub;
            }
        }
